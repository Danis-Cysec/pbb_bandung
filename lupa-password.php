    ...
    <section id="contact-page">
        <div class="container" style="min-height:420px;">
            ...
            <div class="row contact-wrap"> 
                ...
                <form class="contact-form" method="post" action="libs/lupa-password-user.php">
                    <div class="col-sm-6 col-sm-offset-3">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" class="btn btn-primary btn-lg" required="required">Reset Password</button>
                        </div>
