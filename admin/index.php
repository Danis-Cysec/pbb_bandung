   ...
   <header id="header">
            ...
            <div class="container">
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#">Daftar Pengajuan</a></li>
    ...
    <section id="contact-page">
        <div class="container" style="min-height:420px;">
            <div class="center">
            	<h2></h2> 
                <h2>Daftar Pengajuan Objek Pajak Baru</h2>
            ...
            <div id="hasil" class="row contact-wrap">
            	<table class="table">
                    ...
                    <?php
						$link = koneksi_db();
						$sql = "select * from daftarpengajuan where status = 'Belum Disetujui' order by id_pengajuan";
						$res = $link->query($sql);
					...
					?>
                        <tr class="table-row">
                            <td class="table-text">
                                <h4>Pengajuan #<?php echo $row['id_pengajuan'];?></h4>
                            ...
                            <td style="width:10px;padding:20px;">
                                <a href="ubah-pengajuan.php?id_pengajuan=<?php echo $row['id_pengajuan'];?>"><i class="fa fa-check-square-o icon_9"></i></a>
                            </td>
                        </tr>
                        <?php } 
						} ?>
    ...
    <script>
		function search() {
			...
			xmlhttp.open("GET","../libs/cari-pengajuan.php?status="+status,true);
			xmlhttp.send();
		}
	</script>
</body>
