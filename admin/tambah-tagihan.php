                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="#">Tambah Tagihan</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
        ...
        <div class="container" style="min-height:420px;">
            ...
            <div class="row contact-wrap">
                <div class="col-sm-6 col-sm-offset-3">
	            	<form class="contact-form" method="post" action="../libs/tambah-tagihan.php">
                    	<div class="form-group">
                            <label>NOP *</label>
                            <input type="text" name="nop" class="form-control" required maxlength="16" onkeypress="return event.charCode >= 48 && event.charCode <= 57"> 	
                        </div>
                        <div class="form-group">
