...
<body class="homepage">
   ...
   <header id="header">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="#">Daftar Admin</a></li>
        ...
        <div class="container" style="min-height:420px;">
            ...
            <div class="row contact-wrap">
            	<div class="col-sm-12"> 
                    ...
                    <div class="col-sm-2">
                        <label>Cari</label>
                    	<input type="search" id="search" name="search" placeholder="NIP" class="form-control left" maxlength="18" onKeyUp="search()">
                    </div>
                </div>
            </div>
    ...
    <script>
		function search() {
			var nip = document.getElementById("search").value;
			...
			xmlhttp.open("GET","../libs/cari-admin.php?nip="+nip,true);
			xmlhttp.send();
		}
	</script>
</body>
