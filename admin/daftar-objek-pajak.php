   ...
   <header id="header">
            ...
            <div class="container">
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="#">Objek Pajak</a></li>
        ...
        <div class="container" style="min-height:420px;">
            ...
            <div class="row contact-wrap">
            	<div class="col-sm-12"> 
                    ...
                    <div class="col-sm-2">
                        <label>Cari</label>
                    	<input type="search" id="search" name="search" placeholder="NOP" class="form-control left" maxlength="18" onKeyUp="search()">
                    </div>
                </div>
            </div>
    ...
    <script>
		function search() {
			...
			xmlhttp.open("GET","../libs/cari-objek-pajak.php?nop="+nop,true);
			xmlhttp.send();
		}
	</script>
</body>
